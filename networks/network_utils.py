...
from networks.Tiny_U_Net import Tiny_U_Net
...
def set_model(model_name, in_channels=2, out_channels=3, out_layers=1):
    ...
    elif model_name == 'Tiny_U_Net':
        model = Tiny_U_Net(in_channels=in_channels, out_channels=out_channels, out_layers=out_layers)
